...
typedef struct _OF_FrameData
{
    ...
    OFInt32 orientation;                    /* [in] For android, it is the orientation of the camera image. 0, 90, 180, 270 */
...
* the funtion use the local license offline check.
 ...
 * of failure
 * @param[in] venusModelDirPath, path of venus models directory, e,g "d:/venus_models",
...
OF_API OF_Result OF_CreateContext(
    ...
    const char* venusModelDirPath);             /* [in] */
