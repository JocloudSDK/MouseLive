 ...
 * @author xipeitao
 * @description:
 * @date : 2020/4/26 4:32 PM
 */
public class VoiceConfig extends ThunderConfig{
    @Override
    public int getMediaMode() {
        return ThunderRtcConstant.ThunderRtcProfile.THUNDER_PROFILE_ONLY_AUDIO;
    }

    @Override
    public int getRoomMode() {
        return ThunderRtcConstant.RoomConfig.THUNDER_ROOMCONFIG_CONFERENCE;
    }
