...
/**
 * Accelerometer 用于开启重力传感器以获得当前手机朝向
 */
public class MagicAccelerometerProcesser {
    /**
     * CLOCKWISE_ANGLE 为手机旋转角度
     * 其 Deg0 定义如下图所示
     *  ___________________
     * | +--------------+  |
     * | |              |  |
    ...
    /**
     * Activity 初始化获得传感器管理对象
     * @param ctx 应用上下文
     */
    public MagicAccelerometerProcesser(Context ctx) {
